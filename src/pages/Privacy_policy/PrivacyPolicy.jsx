...
import classes from '../Terms_of_use/TermsOfUse.module.css';
import { Link } from "react-router-dom";


const PrivacyPolicy = () => {
  return (
    <div id={classes.termsOfUseDiv}>
      <p id={classes.termsTitle}>Privacy Policy - You Can Bake It! </p>
      <p id={classes.termsUpdate}>Privacy Policy Last Updated: 27.10.2023 </p>
      <p>
      ...
      <p className={classes.title}>1. Information Collection:</p>
      <p>
        {' '}
      ...
      <p className={classes.title}> 2. Information Usage: </p>
      <p>
      ...
      <p className={classes.title}> 3. Cookies: </p>
      <p>
      ...
      <p className={classes.title}> 4. Security: </p>
      <p>
      ...
      <p className={classes.title}> 5. Third-Party Links: </p>
      <p>
