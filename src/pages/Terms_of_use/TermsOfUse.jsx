...
const TermsOfUse = () => {
  return (
    <div className={classes.termsOfUseDiv}>
      <p className={classes.termsTitle}>Terms of Use You Can Bake It! </p>
      <p className={classes.termsUpdate}>
        Terms of Use Last Updated: 27.10.2023{' '}
      </p>
      <p>
      ...
      <p className={classes.title}> 1. Content Usage:</p>
      <p>
        {' '}
      ...
      <p className={classes.title}> 2. User-Generated Content: </p>
      <p>
      ...
      <p className={classes.title}> 3. Accuracy and Reliability: </p>
      <p>
      ...
      <p className={classes.title}> 4. Links to External Websites: </p>
      <p>
      ...
      <p className={classes.title}> 5. Termination: </p>
      <p>
      ...
      <p className={classes.title}> 6. Updates: </p>
      <p>
